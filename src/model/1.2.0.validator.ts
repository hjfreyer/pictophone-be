...
import { Annotation2, JoinGameAction, StartGameAction, MakeMoveAction, Submission, Action, Error, UnstartedGame, UnstartedGamePlayer, StartedGame, StartedGamePlayer, Game, State, CreateGameAction, ShortCode } from './1.2.0';
    ...
    "definitions": {
        ...
        "Annotation2": {
            ...
            "properties": {
                ...
                "parents": {
                    "$ref": "#/definitions/Record<string,ParentLink>"
                },
                "state": {
                    "$ref": "#/definitions/TState"
                }
            },
            "required": [
                "labels",
...
export function validate(typeName: 'Annotation2'): (value: unknown) => Annotation2;
