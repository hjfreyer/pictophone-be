...
import { JoinGameAction, StartGameAction, MakeMoveAction, ActionSubmission, Action, Error, BoringPlayerGame, RespondToPromptPlayerGame, FinishedPlayerGame, ExportedSeries, ExportedSeriesEntry, PlayerGame, GameList } from './1.0';
...
export function validate(typeName: 'ActionSubmission'): (value: unknown) => ActionSubmission;
