...
import { JoinGameAction, StartGameAction, MakeMoveAction, Action, Error, Submission, UnstartedGame, UnstartedGamePlayer, StartedGame, StartedGamePlayer, Game, State, Facets, Annotations } from './1.1.1';
...
export function validate(typeName: 'Facets'): (value: unknown) => Facets;
