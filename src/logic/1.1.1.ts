...
type IntegrationResult1_1_1 =
    fw.IntegrationResult<Result<null, state1_1_1.Error>, state1_1_1.Game>;

export const THING: fw.Revision<Result<null, state1_1_1.Error>, state1_1_1.Game> = {
    id: '1.1.1',
    validateAnnotation: validate('Annotations'),

    async integrate(action: AnyAction, inputs: fw.Input<state1_1_1.Game>): Promise<IntegrationResult1_1_1> {
    ...
    async activateFacet(db: db.Database, label: string, maybeOldGame: OptionData<state1_1_1.Game>, newGame: OptionData<state1_1_1.Game>): Promise<void> {
