...
export async function purgeDeprecated(tx: db.TxRunner): Promise<void> {
    console.log('DELETING: 1.0.0');
    await deleteCollection(tx, "1.0.0");
    console.log('DELETING: 1.0.1');
    await deleteCollection(tx, "1.0.1");
    console.log('DELETING: 1.1.0');
    await deleteCollection(tx, "1.1.0");
}
