...
import {ActionRequest, Action, JoinGame, StartGame, MakeMove, Submission, Upload, CompressedDrawing, PlayerGame, UnstartedGame, FirstPromptGame, WaitingForPromptGame, RespondToPromptGame, FinishedGame, Series, SeriesEntry, Drawing, Path, Point, GameLog, GameLogEntry, Ref} from './types';
export const ajv = new Ajv({"allErrors":true,"coerceTypes":false,"format":"fast","nullable":true,"unicode":true,"uniqueItems":true,"useDefaults":true});

ajv.addMetaSchema(require('ajv/lib/refs/json-schema-draft-06.json'));

export {ActionRequest, Action, JoinGame, StartGame, MakeMove, Submission, Upload, CompressedDrawing, PlayerGame, UnstartedGame, FirstPromptGame, WaitingForPromptGame, RespondToPromptGame, FinishedGame, Series, SeriesEntry, Drawing, Path, Point, GameLog, GameLogEntry, Ref};
export const Schema = {
