...
import {GameLog, GameLogEntry, Action, JoinGame, StartGame, MakeMove, Submission, PlayerGame, SimpleGame, PromptGame, FinishedGame} from './types';
export const ajv = new Ajv({"allErrors":true,"coerceTypes":false,"format":"fast","nullable":true,"unicode":true,"uniqueItems":true,"useDefaults":true});

ajv.addMetaSchema(require('ajv/lib/refs/json-schema-draft-06.json'));

export {GameLog, GameLogEntry, Action, JoinGame, StartGame, MakeMove, Submission, PlayerGame, SimpleGame, PromptGame, FinishedGame};
export const Schema = {
