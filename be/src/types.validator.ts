...
import {Action, JoinGame, StartGame, MakeMove, History, Game, UnstartedGame, ActiveGame, FinishedGame, Log, Entry, HistoryProjection, PlayerGame, Projection2_0, PlayerGame2_0, PlayerGame2_0_Basic, PlayerGame2_0_Respond} from './types';
...
export {Action, JoinGame, StartGame, MakeMove, History, Game, UnstartedGame, ActiveGame, FinishedGame, Log, Entry, HistoryProjection, PlayerGame, Projection2_0, PlayerGame2_0, PlayerGame2_0_Basic, PlayerGame2_0_Respond};
export const Schema = {
...
export function validate(typeName: 'Projection2_0'): (value: unknown) => Projection2_0;
export function validate(typeName: 'PlayerGame2_0'): (value: unknown) => PlayerGame2_0;
export function validate(typeName: 'PlayerGame2_0_Basic'): (value: unknown) => PlayerGame2_0_Basic;
export function validate(typeName: 'PlayerGame2_0_Respond'): (value: unknown) => PlayerGame2_0_Respond;
